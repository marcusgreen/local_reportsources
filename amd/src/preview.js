 ...
 * report, inline, via the Fragment API (see local_reportsources_output_fragment_preview()).
 *
 ...
 *
 * @module     local_reportsources/preview
...
export const init = (btnid, sqlid, courseid, regionid, detailsid) => {
    ...
    btn.addEventListener('click', async() => {
        ...
        btn.disabled = true;
        region.textContent = await getString('previewloading', 'local_reportsources');
