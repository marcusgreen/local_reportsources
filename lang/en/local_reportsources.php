...
$string['samples:intro'] = '{$a} sample report views are bundled with this plugin. Loading creates each as a draft owned by you that you must publish before use.';
$string['samples:linklabel'] = 'Load sample report views';
...
$string['settings:showlastmodified_desc'] = 'Show a sortable "Last modified" column in the report views list.';
