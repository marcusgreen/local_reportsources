...
$string['gradessource'] = 'Gradebook grades';
$string['gradessource:grade'] = 'Grade';
$string['gradessource:itemtype'] = 'Grade item type';
$string['gradessource:module'] = 'Activity';
$string['gradessource:rawgrade'] = 'Raw grade';
...
$string['settings:datasources'] = 'Bundled report datasources';
$string['settings:datasources_desc'] = 'Ready-made PHP Report Builder datasources shipped with this plugin. Enabling one makes it selectable in Reports → Report builder → New report. Disabling one only hides it from new report creation; reports already built on it keep working.';
...
$string['settings:enablegradessource'] = 'Gradebook grades datasource';
$string['settings:enablegradessource_desc'] = 'Add a "Gradebook grades" datasource to Report Builder, exposing user grades across courses with proper grade display formatting and hidden-grade protection (moodle/grade:viewhidden).';
