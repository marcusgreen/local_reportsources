...
$string['errgroupaggregation'] = 'This report aggregates one or more columns. Grouped (control-break) view cannot be combined with column aggregation — remove the aggregation or use the standard report view.';
$string['errgroupnotactivecol'] = 'The break column "{$a}" is not a column of this report. Add it back to the report in the Report Builder editor, or choose a different break column under Grouping.';
