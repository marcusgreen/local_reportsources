...
use local_reportsources\task\purge_views;
 ...
 * @covers    \local_reportsources\task\purge_views
 */
final class purge_views_test extends \advanced_testcase {
    ...
    public function test_execute_deletes_only_old_rows(): void {
        ...
        set_config('viewretaindays', 30, 'local_reportsources');
        $now = time();
    ...
    public function test_execute_keeps_all_when_retention_zero(): void {
        ...
        set_config('viewretaindays', 0, 'local_reportsources');
