 ...
 * @covers    \local_reportsources\reportbuilder\local\systemreports\usage
 */
final class usage_report_test extends \advanced_testcase {
    ...
    public function test_report_lists_published_with_view_counts(): void {
        ...
        $PAGE->set_url(new \moodle_url('/local/reportsources/usage.php'));
        $report = system_report_factory::create(usage::class, \context_system::instance(), 'local_reportsources');
