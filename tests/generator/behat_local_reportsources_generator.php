...
/**
 * Behat data generator for local_reportsources.
 *
 * Lets feature files create report-source queries with:
 *   Given the following "local_reportsources > queries" exist:
 ...
 */
class behat_local_reportsources_generator extends behat_generator_base {
    /**
