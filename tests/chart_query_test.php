...
use local_reportsources\reportbuilder\local\entities\chart_view;
use local_reportsources\reportbuilder\source\chart_query;
 ...
 * @covers    \local_reportsources\reportbuilder\source\chart_query
 * @covers    \local_reportsources\reportbuilder\local\entities\chart_view
 */
final class chart_query_test extends \advanced_testcase {
    ...
    public function test_publish_with_chart_creates_chart_report(): void {
        ...
        $bound = (int) get_config('local_reportsources', 'queryid_for_report_' . $chartreport->get('id'));
    ...
    public function test_switch_to_no_chart_deletes_chart_report(): void {
        ...
        $this->assertCount(0, $this->chart_reports());
        $this->assertFalse(get_config('local_reportsources', 'queryid_for_report_' . $chartreportid));
