...
use local_reportsources\output\embed_renderer;
 ...
 * @covers    \local_reportsources\output\embed_renderer
 */
final class embed_renderer_test extends \advanced_testcase {
    ...
    public function test_render_table_empty_rows_shows_norows_message(): void {
        ...
        $this->assertStringContainsString(get_string('norows', 'local_reportsources'), $html);
