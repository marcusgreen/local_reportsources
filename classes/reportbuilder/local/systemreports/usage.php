 ...
 *
 * Reads the local_reportsources_queryview audit table (via the entity's viewcount/lastviewed
...
class usage extends system_report {
    ...
    protected function initialise(): void {
        ...
        $this->set_downloadable(true, get_string('usage:title', 'local_reportsources'));
    }
    ...
    protected function can_view(): bool {
        return has_capability('local/reportsources:viewall', $this->get_context());
    }
}
